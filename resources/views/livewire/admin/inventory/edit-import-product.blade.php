<form wire:submit='update2ImportProduct'>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-3 py-1.5 whitespace-nowrap text-center" valign="top">
                                                <div class="flex items-center justify-center gap-2">
                                                    ...
                                                    @endif
                                                    @if ($index >= $existing_detail_count)
                                                        <button type="button" wire:click="removeImportProductDetail({{$index}})" class="inline-flex items-center px-2 py-2 bg-red-500 border border-transparent rounded-md font-semibold text-xs text-white tracking-widest hover:bg-red-600 active:bg-red-700 focus:outline-none focus:border-red-900 focus:ring ring-red-300 disabled:opacity-25 transition ease-in-out duration-150">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="10" height="10" viewBox="0 0 24 24">
