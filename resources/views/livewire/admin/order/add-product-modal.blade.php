    ...
    <form class="p-4 md:p-5" wire:submit.prevent="storeOrderProduct" onsubmit="return false">
        <div class="grid gap-4 mb-4 grid-cols-2">
            ...
            <div class="col-span-1">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mẫu <span class="text-red-700">*</span></label>
                <div class="mt-2">
            ...
            <div class="col-span-1">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Size <span class="text-red-700">*</span></label>
                <div class="mt-2">
            ...
            <div class="col-span-1">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Số lượng <span class="text-red-700">*</span></label>
                <div class="mt-2">
            ...
            <div class="col-span-1">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Đơn giá <span class="text-red-700">*</span></label>
                <div class="mt-2">
            ...
            <div class="col-span-1">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Thành tiền <span class="text-red-700">*</span></label>
                <div class="mt-2">
